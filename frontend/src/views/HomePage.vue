  ...
  <div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto px-4 py-8">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-500">Утоли внутреннего шопоголика!</p>
      </div>
        ...
        <main class="flex-grow">
          ...
          <div class="mb-6 flex items-center justify-between">
            <p class="text-gray-700">
              ...
              {{ productsStore.productsCount === 1 ? 'товар найден' : 'товаров найдено' }}
            </p>
          ...
          <div v-else class="text-center py-12">
            ...
            <p class="text-gray-500 text-lg font-medium">Товаров не найдено</p>
            <button
              @click="productsStore.clearCategoryFilter"
